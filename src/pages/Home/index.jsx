...
function Home() {
  ...
  const [selectedVideoUrl, setSelectedVideoUrl] = useState('https://www.youtube.com/watch?v=TTM_b7EJg5E');
  const [selectedVideoTitle, setSelectedVideoTitle] = useState('The Do\'s and Don\'ts of Error Handling');
